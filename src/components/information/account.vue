<template>
	<div class="account">
		<div class="account_bg" v-if="bankAccount != '' && bankName !='' && bankAccountName !='' ">
		    ...
		    <div class="remind">
		    	<span>提醒:</span>
		    	<p>1.如果申请成功，今晚生效。请记得将还款金额存入新的代扣账号中。</p>
...
<style scoped>
	...
	.account .account_bg{background:#fff;}
    ...
    .remind{color:#8CA3B5;font-size:16px;padding:15px 10px;}

</style>
<style>
	.account_list .vux-label{color:#A9B2B9;}
