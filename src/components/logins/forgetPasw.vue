...
<style scoped>
	...
	.forget_input .weui-vcode .weui-cell__ft span.yan{width:55px;height:22px;display: inline-block;text-align: center;}
	.forget_input .weui-vcode .weui-cell__ft span.hine{background:url(../../assets/yan_icon.png) no-repeat left center;background-size:35px auto;}
    .forget_input .weui-vcode .weui-cell__ft span.off{background:url(../../assets/QM_icon.png) no-repeat left center;background-size:35px auto;}
...
<style>
    ...
    .forget_input .weui-btn_primary{background:none;border:2px solid #2490FF;color:#2490FF}
</style>